...
@Component(service = Servlet.class, property = {
		Constants.SERVICE_DESCRIPTION
				+ "=Short App Employee Fee Waiver Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST,
		"sling.servlet.paths=" + "/bin/getShortAppEmpFeeWaiver" })
public class CSUFShortAppEmpFeeWaiverServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(CSUFShortAppEmpFeeWaiverServlet.class);
	...
	public void doGet(SlingHttpServletRequest req,
		...
		if (conn != null) {
			try {
				...
				emplEvalDetails = getEmployeeEvalDetails(userID, conn);
	...
	public static JSONArray getEmployeeEvalDetails(String userID,
			Connection oConnection) throws Exception {
		ResultSet oRresultSet = null;
		JSONObject employeeEvalDetails;
		JSONArray jArray = new JSONArray();
		String emplIDSQL = CSUFConstants.shortAppEmpFeeWaiver;
