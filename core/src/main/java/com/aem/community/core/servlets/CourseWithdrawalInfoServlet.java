...
//					studentInfo.put("STUDENT_PHONE", "7457891080");
					...
					//studentInfo.put("DESCR TERM_DESCR",oRresultSet.getString("DESCR TERM_DESCR"));
...
//				courseInfo.put("CHAIR_EMAIL", "inat@fullerton.edu");
				...
				// logger.error(sClassName, methodName, "Record Count : " + i);
...
//		String methodName = "getCaseID";
	...
	private static String[] getChairInfo(Connection oConnection, String courseId) throws Exception {
		...
		try {
			...
			//String sql = "Select * from AR_Course_Chair_Info where CRSE_ID = '<<CRSE_ID>>' and CRSE_NAME='<<courseName>>'";
