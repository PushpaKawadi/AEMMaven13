...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/getMppPerfEvalEmpLookup" })
public class CSUFMPPPerfEvalEmpLookup extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(CSUFMPPPerfEvalEmpLookup.class);
	...
	public static JSONArray getEmployeeEvalDetails(String cwid,
		...
		String emplIDSQL = CSUFConstants.mppEmpIDSQL;
		//String lookupFields = ConfigManager.getValue("lookupFields");
		String lookupFields = CSUFConstants.mppLookUpFields;
