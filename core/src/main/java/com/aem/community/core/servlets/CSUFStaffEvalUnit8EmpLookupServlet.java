...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Staff Evaluation Unit 8 Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + "/bin/staffEvalUnit8EmplIDLookup" })
public class CSUFStaffEvalUnit8EmpLookupServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory.getLogger(CSUFStaffEvalUnit8EmpLookupServlet.class);
	...
	public static JSONArray getEmployeeEvalDetails(String cwid, Connection oConnection, String userID, String docType)
		...
		String emplIDSQL = CSUFConstants.staffEvalUnit8EmplIDSQL;
		String lookupFields = CSUFConstants.lookupFieldsUnit8EmpLookup;
