...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/getAllAdditionalMajorsCode" })
public class CSUFMajorMinorChangeAllAdditionalMajorsCODEServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(CSUFMajorMinorChangeAllAdditionalMajorsCODEServlet.class);
	...
	public static JSONArray getStudentInformationDetails(String trnscrDescr,
		...
		try {
				...
				majorMinorChangeInfoSQL = CSUFConstants.getAllAdditionalMajorsAcadPlan;
				logger.info("Updated ADDITIONAL Major SQL is======"+majorMinorChangeInfoSQL);				
