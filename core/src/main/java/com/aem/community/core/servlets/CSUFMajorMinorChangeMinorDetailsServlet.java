...
//		"sling.servlet.methods=" + HttpConstants.METHOD_GET, "sling.servlet.paths=" + "/bin/getCurrentMinors" })
//public class CSUFMajorMinorChangeMinorDetailsServlet extends SlingSafeMethodsServlet {
//	private final static Logger logger = LoggerFactory.getLogger(CSUFMajorMinorChangeMinorDetailsServlet.class);
...
//		try {
//			
//			majorMinorChangeInfoSQL = CSUFConstants.getCurrentMinorsUpdated;
...
//				instInfo.put("Current_Minors", oRresultSet.getString("PROGRAMS"));
//				
//				jArray.put(instInfo);
//				
//			}
