...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Staff Evaluation Confidential Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + "/bin/staffEvalConfEmplIDLookup" })
public class CSUFStaffEvalConfEmpLookupServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory.getLogger(CSUFStaffEvalConfEmpLookupServlet.class);
	...
	public static JSONArray getEmployeeEvalDetails(String cwid, Connection oConnection, String userID) {
		ResultSet oRresultSet = null;
		JSONObject employeeEvalDetails;
		JSONArray jArray = new JSONArray();
		String emplIDSQL = CSUFConstants.staffEvalConfEmplIDSQL;
		String lookupFields = CSUFConstants.lookupFieldsConfEmpLookup;
