...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Staff Evaluation Unit 6 Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + "/bin/staffEvalUnit6EmplIDLookup" })
public class CSUFStaffEvalUnit6EmpLookupServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory.getLogger(CSUFStaffEvalUnit6EmpLookupServlet.class);
	...
	public static JSONArray getEmployeeEvalDetails(String cwid, Connection oConnection, String userID, String docType)
		...
		String emplIDSQL = CSUFConstants.staffEvalUnit6EmplIDSQL;
		String lookupFields = CSUFConstants.lookupFieldsUnit6EmpLookup;
