...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/getPersonnelActiveNotice" })
public class CSUFPersonnelActiveNotice extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(CSUFPersonnelActiveNotice.class);
	...
	public static JSONArray getEmployeeEvalDetails(String cwid,
		...
		String emplIDSQL = CSUFConstants.personnelActionPlan;
		String lookupFields = CSUFConstants.personnelActionPlanFields;
		...
		try {
			...
			try {
				...
				logger.error("Exception in CSUFPersonnelActiveNotice="
						+ e.getMessage());
				e.getStackTrace();
			}
		}
