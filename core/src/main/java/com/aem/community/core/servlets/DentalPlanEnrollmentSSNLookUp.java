...
public class DentalPlanEnrollmentSSNLookUp extends SlingSafeMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest req, SlingHttpServletResponse response)
		...
		if (conn != null) {
			try {
				...
				newPositionManagerDetails = getCareerDevelopmentPlanDetails(ssn, conn, "detalPlanEnrollment");
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public static JSONArray getCareerDevelopmentPlanDetails(String ssn, Connection oConnection, String docType)
			throws Exception {
