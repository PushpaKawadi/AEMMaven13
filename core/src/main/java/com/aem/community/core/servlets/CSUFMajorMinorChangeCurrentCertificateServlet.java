...
//		"sling.servlet.methods=" + HttpConstants.METHOD_GET, "sling.servlet.paths=" + "/bin/getCurrentCertificate" })
//public class CSUFMajorMinorChangeCurrentCertificateServlet extends SlingSafeMethodsServlet {
//	private final static Logger logger = LoggerFactory.getLogger(CSUFMajorMinorChangeCurrentCertificateServlet.class);
...
//		try {
//			
//			majorMinorChangeInfoSQL = CSUFConstants.getCurrentCertificates;
...
//				instInfo.put("Current_Certificate", oRresultSet.getString("PROGRAMS"));
//				
//				jArray.put(instInfo);
//				
//			}
