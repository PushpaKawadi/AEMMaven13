...
//		"sling.servlet.paths=" + "/bin/getAllCertificatesCode" })
//public class CSUFMajorMinorChangeCertificatesCODEServlet extends SlingSafeMethodsServlet {
//	private final static Logger logger = LoggerFactory
//			.getLogger(CSUFMajorMinorChangeCertificatesCODEServlet.class);
...
//				majorMinorChangeDetails = getStudentInformationDetails(trnscrDescr, descr, conn);
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
...
//	 * @throws Exception
//	 */
//	public static JSONArray getStudentInformationDetails(String trnscrDescr, String descr,
...
//				if(trnscrDescr != null) {
//					
//					majorMinorChangeInfoSQL = CSUFConstants.getAllCertificateAcadPlan;
//					logger.info("All Certificate Acad Plan = "+ majorMinorChangeInfoSQL);
//					
//					majorMinorChangeInfoSQL = majorMinorChangeInfoSQL.replaceAll("<<PROGRAM>>", trnscrDescr);					
//				} 
//				else if(descr != null) {
//					
//					majorMinorChangeInfoSQL = CSUFConstants.getCurrentCertificateAcadPlan;								
//				
//					majorMinorChangeInfoSQL = majorMinorChangeInfoSQL.replaceAll("<<PROGRAM>>", descr);
//					logger.info("Current Certificate Acad Plan = "+ majorMinorChangeInfoSQL);
//				}
//							
//			try {
//				
