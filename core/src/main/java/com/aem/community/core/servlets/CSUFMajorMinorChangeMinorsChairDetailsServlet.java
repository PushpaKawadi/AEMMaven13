...
//		"sling.servlet.paths=" + "/bin/getCurrentMajorAndMinorChairDetails" })
...
//		if ((req.getParameter("Programs") != null && !req.getParameter("Programs").trim().equals(""))) {
//			program = req.getParameter("Programs"); 			
//				
//			
...
//				degreeDetails = getCurrentMajorMinorChairDetails(program,  conn);
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
...
//	 * @throws Exception
//	 */
//	public static JSONArray getCurrentMajorMinorChairDetails(String program,
//			Connection conn) throws Exception {
//
//		logger.info("Inside get Current Major And Minor Chair Details");		
//
...
//		try {		
//					degreeInfoSQL = CSUFConstants.getCurrentMajorAndMinorChairDetails;	
//					logger.info("SQL query before= "+ degreeInfoSQL);
//																
//					degreeInfoSQL = degreeInfoSQL.replaceAll("<<PROGRAMS>>", program);
