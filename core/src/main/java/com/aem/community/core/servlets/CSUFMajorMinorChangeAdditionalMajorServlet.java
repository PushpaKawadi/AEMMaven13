...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/getAllAdditionalMajors" })
public class CSUFMajorMinorChangeAdditionalMajorServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(CSUFMajorMinorChangeAdditionalMajorServlet.class);
	...
	public static JSONArray getStudentInformationDetails(String acadProg, String trnscrDescr,
		...
		try {
				...
				majorMinorChangeInfoSQL = CSUFConstants.getAllAdditionalMajors;	
				logger.info("Updated ALl Additional Major SQL is======"+majorMinorChangeInfoSQL);
