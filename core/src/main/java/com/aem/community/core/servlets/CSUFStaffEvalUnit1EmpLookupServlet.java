...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Staff Evaluation Unit 1 Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + "/bin/staffEvalUnit1EmplIDLookup" })
public class CSUFStaffEvalUnit1EmpLookupServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory.getLogger(CSUFStaffEvalUnit1EmpLookupServlet.class);
	...
	public static JSONArray getEmployeeEvalDetails(String cwid, Connection oConnection, String userID, String docType)
		...
		String emplIDSQL = CSUFConstants.staffEvalUnit1EmplIDSQL;
		String lookupFields = CSUFConstants.lookupFieldsUnit1EmpLookup;
