...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/getAllMinorsCode" })
public class CSUFMajorMinorChangeMinorsCODEServlet extends SlingSafeMethodsServlet {
	private final static Logger logger = LoggerFactory
			.getLogger(CSUFMajorMinorChangeMinorsCODEServlet.class);
	...
	public static JSONArray getStudentInformationDetails(String trnscrDescr, String descr,
		...
		try {
				if(trnscrDescr != null) {
					...
					majorMinorChangeInfoSQL = CSUFConstants.getAllMinorAcadPlan;									
					
					majorMinorChangeInfoSQL = majorMinorChangeInfoSQL.replaceAll("<<PROGRAM>>", trnscrDescr);					
				} 
				else if(descr != null) {
					
					majorMinorChangeInfoSQL = CSUFConstants.getCurrentMinorAcadPlan;								
