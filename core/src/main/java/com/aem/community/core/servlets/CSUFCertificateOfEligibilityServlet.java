...
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Certificate Eligibility Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + "/bin/getCertEligibility" })
public class CSUFCertificateOfEligibilityServlet extends SlingSafeMethodsServlet {
