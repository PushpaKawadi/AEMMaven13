...
@Component(service = ParticipantStepChooser.class, property = {
		"chooser.label=Career Development Plan Dynamic Participant Chooser" })

public class CSUFCareerDevelopmentPlanParticipantChooser implements ParticipantStepChooser {
	private static final Logger logger = LoggerFactory.getLogger(CSUFCareerDevelopmentPlanParticipantChooser.class);

	public String getParticipant(WorkItem workItem, WorkflowSession wfSession, MetaDataMap metaDataMap)
			throws WorkflowException {
		logger.info(
				"################ Inside the Career Development Plan GetParticipant ##########################");
		String participant = "";
